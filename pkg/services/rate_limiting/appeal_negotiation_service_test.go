...
func TestSendMessage(t *testing.T) {
	...
	// Create test appeal
	appeal := &Appeal{ID: 1, UserID: 100, Status: StatusPending, CreatedAt: time.Now()}
...
func TestGetNegotiationThread(t *testing.T) {
	...
	appeal := &Appeal{ID: 2, UserID: 101, Status: StatusPending, CreatedAt: time.Now()}
	db.Table("appeals").Create(appeal)
...
func TestPinMessage(t *testing.T) {
	...
	appeal := &Appeal{ID: 3, UserID: 201, Status: StatusPending, CreatedAt: time.Now()}
	db.Table("appeals").Create(appeal)
...
func TestGetPinnedMessages(t *testing.T) {
	...
	appeal := &Appeal{ID: 4, UserID: 202, Status: StatusPending, CreatedAt: time.Now()}
	db.Table("appeals").Create(appeal)
...
func TestAnalyzeConversationTone(t *testing.T) {
	...
	appeal := &Appeal{ID: 5, UserID: 203, Status: StatusPending, CreatedAt: time.Now()}
	db.Table("appeals").Create(appeal)
...
func TestGetNegotiationMetrics(t *testing.T) {
	...
	appeal := &Appeal{ID: 6, UserID: 204, Status: StatusPending, CreatedAt: time.Now()}
	db.Table("appeals").Create(appeal)
...
func BenchmarkSendMessage(b *testing.B) {
	...
	appeal := &Appeal{ID: 100, UserID: 1000, Status: StatusPending, CreatedAt: time.Now()}
	db.Table("appeals").Create(appeal)
...
func BenchmarkGetNegotiationThread(b *testing.B) {
	...
	appeal := &Appeal{ID: 101, UserID: 1001, Status: StatusPending, CreatedAt: time.Now()}
	db.Table("appeals").Create(appeal)
